...
<li>
                ...
                <div class="vehicle_title">
                  ...
                  <p><b>Dari tanggal:</b> <?php echo htmlentities($result->FromDate);?><br /> <b>Sampai saat ini:</b> <?php echo htmlentities($result->ToDate);?></p>
                </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Dibatalkan</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Tertunda</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
