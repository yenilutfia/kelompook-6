...
if($lastInsertId)
{
$msg="Testimonial Berhasil Dikirimkan";
}
else 
{
  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading">
        <h1>Posting Testimonial</h1>
      </div>
      <ul class="coustom-breadcrumb">
        <li><a href="index.php">Home</a></li>
        <li>Posting Testimonial</li>
      </ul>
    </div>
  </div>
  <!-- Dark Overlay-->
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">Post a Testimonial</h5>
            <?php if($error){?><div class="errorWrap"><strong>KESALAHAN</strong>:<?php echo htmlentities($error); ?> </div><?php } 
