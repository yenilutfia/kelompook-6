...
$chngpwd1->execute();
$msg="Berlangganan berhasil.";
}
else {
$error="Kata Sandi Anda Saat Ini Salah.";  
}
}
...
{
alert("Kata Sandi Baru atau Bidang Konfirmasi Kata Sandi tidak cocok.");
