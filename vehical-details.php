...
if($lastInsertId)
{
echo "<script>alert('Pemesanan berhasill.');</script>";
}
else 
{
echo "<script>alert('Ada yang tidak beres. Silakan coba lagi.');</script>";
}
    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>₱<?php echo htmlentities($result->PricePerDay);?> </p>Per Hari
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab">Detil Produk</a></li>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login Untuk Memesan</a>
